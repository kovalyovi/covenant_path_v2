-- Owner-approved admin invites: an invite creates a pending request; the hardcoded owner
-- (ilia.kovaliov@gmail.com) gets an email with a random-token approve link, and only on
