// WebAuthn passkey helper for the Flutter web app. The browser WebAuthn API needs ArrayBuffers,
// but our broker speaks base64url JSON (py_webauthn). This converts between the two so the Dart
// side just passes the broker's options JSON in and gets a server-ready credential JSON back.
